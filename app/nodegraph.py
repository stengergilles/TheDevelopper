...
class NodeGraph(SchemaObject):
	...
	def redraw(self,*args):
		...
		self.l.pos=(self.size[0] - self.l.texture_size[0], self.size[1] - self.l.texture_size[1])
		with self.canvas.before:
			Color(0,0,0)
			Line(points=[c, (c[0],self.size[1] - self.l.texture_size[1]),(self.width,self.size[1] - self.l.texture_size[1])])
	...
	def __init__(self,data=None,**kwargs):
		...
		self.l=MDLabel(text=t,size_hint=(1,None),halign='right',font_style='Caption')
